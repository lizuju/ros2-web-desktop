# vnc-ros | Ubuntu / ROS 2 noVNC 远程桌面（无需 X11 转发）
...
`vnc-ros` 可以让用户在 **macOS、Windows、Linux** 的浏览器里查看和操作远程 Ubuntu / ROS 2 设备上的图形工具，例如 `rviz2`、`rqt`、`rqt_graph`、`rqt_image_view` 和图形终端。
